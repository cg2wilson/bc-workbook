...
},
{
  ...
  "body": " Absolute Extreme Points    Absolute Extrema  Absolute Maximum  Absolute Minimum   A function has an absolute maximum at input if is greater than or equal to all other outputs. Similarly, has an absolute minmium at if is less than or equal to all other outputs.    In practice, there is very little distinction between what we did in 4.2 and what we do here in 4.3; the key difference is determining whether or not the particular max\/min is the greatest or the least output value.    Examples    Consider the function      Locate any extreme values of the function on the interval     Classify the extreme values you found in part (a)       In this question (and in this section), students will confuse the procedure in Section 4.2 with the procedure in this section. Be very clear about setting the input interval\/viewing window appropriately in the calculator.  I'm also not a fan of the phrasing \"classify the extreme values\" that currently exists in the workbook, since you aren't actually doing that. I would say try to make the process clear independent of my bad phrasing.     The critical numbers are     The absolute max is and the absolute min is          Consider the function      Locate any extreme values of the function on the interval .    Classify the extreme values you found in part (a)          The critical points are and     The absolute max is at and the absolute min is at          Consider the function      Locate any extreme values of the function on the interval .    Classify the extreme values you found in part (a)          The critical points are at and     The absolute min is at and the absolute max is at          Consider the function      Locate any extreme values of the function on the interval     Classify the extreme values you found in part (a)       The interval will be weird for them because they're not given a closed interval (hence you can't use the Extreme Value Theorem, like the other questions sort of expect). Remind the students that they know the shape\/end behavior of the function because it's a quartic with positive leading coefficient.  The window may be hard to figure, but starting with is a good starting point.     The only critical number is at     The absolute minimum is at ; there is no absolute maximum.         Find and classify the absolute and relative maxima\/minima for the function on . If necessary, round to the nearest hundredth.    The absolute max is at , the absolute min is at . and are relative mins, and is a relative max.      Find the absolute and relative extrema for the function on . If necessary, round to the nearest hundredth.     is a relative max, is an absolute and local min, and is an absolute max      Find and classify all extrema of the function on . If necessary, round to the nearest hundredth.    The absolute and local max is at , with an absolute min at       Find and classify all extrema of the function on . If necessary, round to the nearest hundredth.     is an absolute\/local min, is the absolute max      Find the relative and absolute maxima and minima of the function on . If necessary, round to the nearest hundredth.    The absolute min is at and the absolute\/local max is at       The sales of a new Starbucks drink are approximated by the function thousand dollars, months after its introduction. Round your answers to the nearest hundredth.     The absolute maximum of drink sales between month 1 and month 15 was BLANK and occurred BLANK months after release.    The absolute minimum of drink sales between month 1 and month 15 was BLANK and occurred BLANK months after release.    Calculate the percent rate of change 4 months after introduction, to the nearest hundredth as a percent.       The exam often has questions phrased like this; ensuring that they are used to the phrasing should help them when it comes to the exam. Be sure to emphasize the rounding AND the units on the answers.     The absolute maximum of drink sales between month 1 and month 15 was 15.18 thousand dollars and occurred 3.49 months after release.    The absolute minimum of drink sales between month 1 and month 15 was 4.74 thousand dollars and occurred 12.41 months after release.    -3.46% per month         The quantity of a drug in the bloodstream hours after a tablet is swallowed is given by  .     How much of the drug is in the bloodstream at time ?    Over the first twelve hours, at what time is the amount of drug in the bloodstream at its highest? What is the maximum amount?          0     The max occurs at         "
},
{
  "id": "definition-32",
  "level": "2",
...
},
{
  ...
  "number": "4.3.3",
  "title": "",
  "body": "  Consider the function      Locate any extreme values of the function on the interval .    Classify the extreme values you found in part (a)          The critical points are and     The absolute max is at and the absolute min is at       "
},
{
  "id": "example-179",
  "level": "2",
  ...
  "number": "4.3.4",
  "title": "",
  "body": "  Consider the function      Locate any extreme values of the function on the interval .    Classify the extreme values you found in part (a)          The critical points are at and     The absolute min is at and the absolute max is at       "
},
{
  "id": "example-180",
  "level": "2",
  ...
  "number": "4.3.5",
  "title": "",
  "body": "  Consider the function      Locate any extreme values of the function on the interval     Classify the extreme values you found in part (a)       The interval will be weird for them because they're not given a closed interval (hence you can't use the Extreme Value Theorem, like the other questions sort of expect). Remind the students that they know the shape\/end behavior of the function because it's a quartic with positive leading coefficient.  The window may be hard to figure, but starting with is a good starting point.     The only critical number is at     The absolute minimum is at ; there is no absolute maximum.      "
},
{
  "id": "example-181",
  "level": "2",
  ...
  "number": "4.3.6",
  "title": "",
  "body": "  Find and classify the absolute and relative maxima\/minima for the function on . If necessary, round to the nearest hundredth.    The absolute max is at , the absolute min is at . and are relative mins, and is a relative max.   "
},
{
  "id": "example-182",
  "level": "2",
  ...
  "number": "4.3.7",
  "title": "",
  "body": "  Find the absolute and relative extrema for the function on . If necessary, round to the nearest hundredth.     is a relative max, is an absolute and local min, and is an absolute max   "
},
{
  "id": "example-183",
  "level": "2",
  ...
  "number": "4.3.8",
  "title": "",
  "body": "  Find and classify all extrema of the function on . If necessary, round to the nearest hundredth.    The absolute and local max is at , with an absolute min at    "
},
{
  "id": "example-184",
  "level": "2",
  ...
  "number": "4.3.9",
  "title": "",
  "body": "  Find and classify all extrema of the function on . If necessary, round to the nearest hundredth.     is an absolute\/local min, is the absolute max   "
},
{
  "id": "example-185",
  "level": "2",
  ...
  "number": "4.3.10",
  "title": "",
  "body": "  Find the relative and absolute maxima and minima of the function on . If necessary, round to the nearest hundredth.    The absolute min is at and the absolute\/local max is at    "
},
{
  "id": "example-186",
  "level": "2",
  ...
  "number": "4.3.11",
  "title": "",
  "body": "  The sales of a new Starbucks drink are approximated by the function thousand dollars, months after its introduction. Round your answers to the nearest hundredth.     The absolute maximum of drink sales between month 1 and month 15 was BLANK and occurred BLANK months after release.    The absolute minimum of drink sales between month 1 and month 15 was BLANK and occurred BLANK months after release.    Calculate the percent rate of change 4 months after introduction, to the nearest hundredth as a percent.       The exam often has questions phrased like this; ensuring that they are used to the phrasing should help them when it comes to the exam. Be sure to emphasize the rounding AND the units on the answers.     The absolute maximum of drink sales between month 1 and month 15 was 15.18 thousand dollars and occurred 3.49 months after release.    The absolute minimum of drink sales between month 1 and month 15 was 4.74 thousand dollars and occurred 12.41 months after release.    -3.46% per month      "
},
{
  "id": "example-187",
  "level": "2",
  ...
  "number": "4.3.12",
  "title": "",
  "body": "  The quantity of a drug in the bloodstream hours after a tablet is swallowed is given by  .     How much of the drug is in the bloodstream at time ?    Over the first twelve hours, at what time is the amount of drug in the bloodstream at its highest? What is the maximum amount?          0     The max occurs at       "
},
{
  "id": "section-44",
  "level": "1",
...
},
{
  ...
  "number": "4.4.5",
  "title": "",
  "body": "  For the function      Write the first and second derivative    Identify any inflection points, and label them as the point of least rapid or most rapid change.           and     There are no inflection points      "
},
{
  "id": "example-190",
  "level": "2",
...
},
{
  ...
  "number": "4.4.7",
  "title": "",
  "body": "  For the function      Write the first and second derivative.    Identify any inflection points, and label them as the point of least rapid or most rapid change.           and      is a point of least rapid change.      "
},
{
  "id": "example-192",
  "level": "2",
  ...
  "number": "4.4.8",
  "title": "",
  "body": "  For the function      Write the first and second derivative.    Identify any inflection points, and label them as the point of least rapid or most rapid change.       This problem can probably be skipped.      and     There are none      "
},
{
  "id": "example-193",
  "level": "2",
  ...
  "number": "4.4.9",
  "title": "",
  "body": "  For the function      Write the first and second derivative.    Identify any inflection points, and label them as the point of least rapid or most rapid change.       The difficulty in this problem is in finding the second derivative of a logistic. They will probably never have to do it on a test, but it's good (I think) to make them practice all the rules together in service of some goal.      and      is a point of most rapid change      "
},
{
  "id": "example-194",
  "level": "2",
  ...
  "number": "4.4.10",
  "title": "",
  "body": "  For the function      Write the first and second derivative.    Identify any inflection points, and label them as the point of least rapid or most rapid change.           and      is a point of most rapid change      "
},
{
  "id": "example-195",
  "level": "2",
  ...
  "number": "4.4.11",
  "title": "",
  "body": "  The table below shows the monthly revenue levels associated with various monthly levels of advertising by a furniture store.    Advertising (in hundreds of dollars)  1  4  7  10  13  16  19    Revenue (in thousands of dollars)  114  210  265  299  338  449  632       Find the complete cubic model for the data (do not align the input).    Write the complete rate of change model for .    Find .    Find the inflection point of on the interval . Round both coordinates to the hundredths place and be sure to label them with units.    Find the rate of change at the inflection point. Round to the hundredths place and include units in your answer.           thousand dollars revenue for a furniture store when hundred dollars are spent on advertising     thousand dollars (revenue) per hundred dollars (advertising), rate of change of revenue for a furniture store when hundred dollars are spent on advertising          hundred dollars and thousand dollars     thousand dollars per hundred dollars      "
},
{
  "id": "example-196",
  "level": "2",
...
},
{
  ...
  "number": "4.6.2",
  "title": "",
  "body": "  A rectangular-shaped garden has one side along the side of a house. The other three sides are to be enclosed with 60 feet of fencing. What is the largest possible area of such a garden?    450 square feet   "
},
{
  "id": "example-199",
  "level": "2",
  ...
  "number": "4.6.3",
  "title": "",
  "body": "  A mason has enough brick to build a 46 foot wall. The homeowners want to use the wall to enclose an outdoor patio. The patio will be along the side of the house and will include a 4-foot opening for a door. What dimensions will maximize the area of the patio?    Let be the length of the patio (with the 4-foot opening) and be the sides. Then, feet and feet.   "
},
{
  "id": "example-200",
  "level": "2",
  ...
  "number": "4.6.4",
  "title": "",
  "body": "  A cylindrical can is made to hold one liter of oil. Find the dimensions that will minimize the cost of the metal to manufacture the can, accurate to the nearest hundredth.    This one has crazy numbers, so it's fine to get skipped. There's plenty of practice otherwise.   and (I think the units are centimeters?)   "
},
{
  "id": "example-201",
  "level": "2",
...
},
{
  ...
  "number": "4.6.7",
  "title": "",
  "body": "  A student organization is planning a bus trip to the Cotton Bowl to cheer on OU football in the playoffs. The bus they charter seats 44 and charges a flat rate of $350 plus $35 per person. However, for ever empty seat on the bus, the charge per person is increased by $2. There is a minimum of 10 passengers. The organization decides that each person going on the trip will pay $35; the organization will pay the flat rate and any additional amount about $35 per person.     Construct a model for the revenue made by the bus company as a function of the number of passengers.    Construct a model for the amount the organization pays as a function of the number of passengers.    For what number of passengers will the bus company's revenue be greatest? For what number of passengers will the bus company's revenue be least?           dollars gives the revenue for the company when passengers go     dollars gives the cost to the organization when passengers go    Max revenue occurs at tickets and minimum revenue occurs at tickets      "
},
{
  "id": "example-204",
  "level": "2",
